...
public class UpdateDocValuesTest extends SolrTest {
    ...
    @Test
    /**
     * The happy path - shows that we can update doc values independent of other
     * fields
     */
    ...
    @Test
    /**
     * We preserve docvalues when updating documents that don't provide a value
     * for their docvalues field
     */
    ...
    private void assertDocValue(String uri, Integer dv) throws SolrServerException {
        ...
        QueryResponse resp = null; // rivey adding catch exception
        try {
    ...
    @Test
    /**
     * The update service throws an error when key field is provided with no
     * value fields
     */
